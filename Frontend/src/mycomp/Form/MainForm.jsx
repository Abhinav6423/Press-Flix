          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="pt-6">
              <button
                ...
                className={`group relative inline-flex h-12 w-full items-center justify-center overflow-hidden rounded-full font-medium transition-all duration-300
    ${isSubmitting
                    ? "bg-zinc-300 text-zinc-600 cursor-not-allowed opacity-90"
                    : "bg-white text-black cursor-pointer hover:bg-zinc-200 hover:shadow-lg hover:shadow-white/10 active:scale-[0.98]"
                  }
  `}
              >
                <span className="mr-2">
                  {isSubmitting ? "Generating Pitch..." : "Generate Your Pitch"}
                </span>

                {isSubmitting ? (
                  /* Animated Loading Spinner */
                  <svg
                    className="animate-spin h-4 w-4 text-zinc-600"
